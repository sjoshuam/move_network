...
class CompileNodes(CompileObjects):
    ...
    def fix_missing(self):
        ...
        self.data = self.data[self.data['id_state'].isin(allowed_states)]
    ...
    def save_data(self):
        ...
        print('TODO: compile_nodes/save_data')
        #print(self)
        return self # TODO

    def execute(self, roster=['census_data', 'geo_data']):
...
if __name__ == '__main__':
    ...
    # execute pipeline
    nodes = CompileNodes(roster=refined_objects).execute()
