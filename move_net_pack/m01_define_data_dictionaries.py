# Create data dictionary for Census ACS data
acs_dict = {
    ...
    ('S0101_C01_006E','pop_age_kid' ,'persons' ,'sum'   ,int),
    ('S0101_C01_030E','pop_age_65+' ,'persons' ,'sum'   ,int),
    ('S1501_C01_001E','pop_edu_all' ,'persons' ,'sum'   ,int),
    ('S1501_C01_015E','pop_edu_ba'  ,'persons' ,'sum'   ,int),
    ('S1501_C01_016E','pop_edu_ma+' ,'persons' ,'sum'   ,int),
    ('S2301_C01_001E','pop_job_all' ,'persons' ,'sum'   ,int),
    ('S2301_C01_002E','pop_job_job' ,'persons' ,'sum'   ,int),
    ('S2301_C01_003E','pop_job_none','persons' ,'sum'   ,int),
    ('S1901_C01_012E','hh_cost_inc' ,'dollars' ,'median',int),
    ('S2503_C01_001E','hh_cost_rent','dollars' ,'median',int),
    ('S2506_C01_001E','hh_cost_home','dollars' ,'median',int),
    ('S0801_C01_049E','commute_time','minutes' ,'median',float),
    ]}
...
state_dict = {
    'header': ('fips_state', 'usps_state', 'name_state'),
    'columns':[
        ...
        ('56', 'WY', 'Wyoming'), ('60', 'AS', 'American Samoa'),
        ('66', 'GU', 'Guam'), ('69', 'MP', 'Northern Mariana Islands'),
        ('72', 'PR', 'Puerto Rico'), ('74', 'UM', 'U.S. Minor Outlying Islands'),
