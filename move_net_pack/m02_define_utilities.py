...
class Utilities:
    ...
    def govern_print_verbosity(str_method, settings=settings):
        '''The print strings for functions on this project are relatively verbose to
        facilitate development.  This wrapper provides a centralized way to silence
        those messages once the code is developed.'''
    ...
    def time_execution(a_function, settings=settings, *args, **kwargs):
        ...
        def exection_timer(*args, **kwargs):
            ...
            if settings.execute_project['verbose']:
                ...
                print(f'TIME TRIAL ({a_function.__name__}): {end_time - start_time}')
            return output
